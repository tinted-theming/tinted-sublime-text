...
import functools
from tinted_theming.themes import THEMES
...
class TintedThemingActivateCommand(sublime_plugin.WindowCommand):
  ...
  def _quick_list_to_scheme(self, index):
    return 'Packages/tinted_theming/color-schemes/%s.sublime-color-scheme' % THEMES[index]
